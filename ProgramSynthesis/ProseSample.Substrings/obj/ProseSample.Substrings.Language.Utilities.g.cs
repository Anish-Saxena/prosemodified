    ...
    public class GrammarBuilders {
        ...
        public class Nodes {
            ...
            public class NodeRules {
                ...
                // This return type could be RuleNodeTypes.SubStr, but it is useful in more cases to already apply the implicit
                // conversion to NodeTypes.sub.
                public NodeTypes.sub SubStr(NodeTypes.v value0, NodeTypes.posPair value1)
                    => new RuleNodeTypes.SubStr(_builders, value0, value1);
                // This return type could be RuleNodeTypes.AbsPos, but it is useful in more cases to already apply the implicit
                // conversion to NodeTypes.pos.
                public NodeTypes.pos AbsPos(NodeTypes.v value0, NodeTypes.k value1)
                    => new RuleNodeTypes.AbsPos(_builders, value0, value1);
                // This return type could be RuleNodeTypes.RegPos, but it is useful in more cases to already apply the implicit
                // conversion to NodeTypes.pos.
                ...
                // This return type could be RuleNodeTypes.PosPair, but it is useful in more cases to already apply the implicit
                // conversion to NodeTypes.posPair.
                ...
                // This return type could be RuleNodeTypes.BoundaryPair, but it is useful in more cases to already apply the implicit
                // conversion to NodeTypes.rr.
...
namespace ProseSample.Substrings.Build.NodeTypes {
    public struct sub : Microsoft.ProgramSynthesis.AST.IProgramNodeBuilder, System.IEquatable<sub> {
        ...
        public static sub? CreateSafe(GrammarBuilders g, ProgramNode node) {
            if (node.GrammarRule.Head != g.Symbol.sub) {
                return null;
            }
            return CreateUnsafe(node);
        }

        public static sub CreateHole(GrammarBuilders g)
            => new sub(g.Hole.sub);
    ...
    public struct posPair : Microsoft.ProgramSynthesis.AST.IProgramNodeBuilder, System.IEquatable<posPair> {
        ...
        public static posPair? CreateSafe(GrammarBuilders g, ProgramNode node) {
            if (node.GrammarRule.Head != g.Symbol.posPair) {
                return null;
            }
            return CreateUnsafe(node);
        }

        public static posPair CreateHole(GrammarBuilders g)
            => new posPair(g.Hole.posPair);
    ...
    public struct pos : Microsoft.ProgramSynthesis.AST.IProgramNodeBuilder, System.IEquatable<pos> {
        ...
        public static pos? CreateSafe(GrammarBuilders g, ProgramNode node) {
            if (node.GrammarRule.Head != g.Symbol.pos) {
                return null;
            }
            return CreateUnsafe(node);
        }

        public static pos CreateHole(GrammarBuilders g)
            => new pos(g.Hole.pos);
    ...
    public struct rr : Microsoft.ProgramSynthesis.AST.IProgramNodeBuilder, System.IEquatable<rr> {
        ...
        public static rr? CreateSafe(GrammarBuilders g, ProgramNode node) {
            if (node.GrammarRule.Head != g.Symbol.rr) {
                return null;
            }
            return CreateUnsafe(node);
        }

        public static rr CreateHole(GrammarBuilders g)
            => new rr(g.Hole.rr);
    ...
    public struct r : Microsoft.ProgramSynthesis.AST.IProgramNodeBuilder, System.IEquatable<r> {
        ...
        public static r? CreateSafe(GrammarBuilders g, ProgramNode node) {
            if (node.GrammarRule.Head != g.Symbol.r) {
                return null;
            }
            return CreateUnsafe(node);
        }

        public static r CreateHole(GrammarBuilders g)
            => new r(g.Hole.r);
    ...
    public struct k : Microsoft.ProgramSynthesis.AST.IProgramNodeBuilder, System.IEquatable<k> {
        ...
        public static k? CreateSafe(GrammarBuilders g, ProgramNode node) {
            if (node.GrammarRule.Head != g.Symbol.k) {
                return null;
            }
            return CreateUnsafe(node);
        }

        public static k CreateHole(GrammarBuilders g)
            => new k(g.Hole.k);
    ...
    public struct v : Microsoft.ProgramSynthesis.AST.IProgramNodeBuilder, System.IEquatable<v> {
        ...
        public static v? CreateSafe(GrammarBuilders g, ProgramNode node) {
            if (node.GrammarRule.Head != g.Symbol.v) {
                return null;
            }
            return CreateUnsafe(node);
        }

        public static v CreateHole(GrammarBuilders g)
            => new v(g.Hole.v);
